...
\section{ニューラルネットワーク}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ニューラルネットワークとは, 人間の脳内にある神経細胞（ニューロン）によって作られる神経回路網を真似て作られた数理モデルである. ニューラルネットワークの歴史は, 1943年に神経生理学者のW. McCullochと数学者のW. Pittsによって, 人の脳を模した数理モデルが提唱されたことに始まる\cite{}. その後, 1957年に数学者のF. Rosenblattにより学習可能なネットワークとしてパーセプトロンが開発された. 
