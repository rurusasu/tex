...
\]
ここで, bはバイアスと呼ばれ, 後に説明する活性化関数において出力信号が1を出力する度合いを調整するパラメータとして機能する.　また, パーセプトロンにおいては一般的にバイアスは$b = 1$を入力とする.
前述の式を一般化すると, 
\begin{eqnarray}
...
ここで${\bf x}$は,  (n+1)次元ベクトル${\bf x} = (x_0, x_1, x_2,  \cdots, x_n)$でありパーセプトロンへの入力を表す. また, $y'$は
